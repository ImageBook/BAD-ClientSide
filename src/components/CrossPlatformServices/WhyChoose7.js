        ...
        <div className='w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto my-10 lg:my-40 text-[#383841]'>
            <div className='flex flex-col lg:flex-row items-center justify-center gap-6 md:gap-10'>
                <div className='w-full lg:w-1/2'>
                    <p className='leading-none text-[40px] lg:text-[56px] font-medium mb-2'>Why choose <br className='hidden lg:block' /> <span className='font-bold'>Textapps</span> for Cross Platform App Development?</p>
