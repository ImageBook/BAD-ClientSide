            ...
            <div ref={ref}>
                <div className='flex flex-col lg:flex-row lg:justify-between items-center gap-16 lg:gap-0 lg:h-screen mt-32 w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto'>
                    ...
                    <div style={{
                        ...
                        {/* add your own text */}
                        <p className='text-[28px] lg:text-[128px] font-black  text-[#383841] leading-none text-center lg:text-right'>GROUND</p>
                        <p className='text-[28px] lg:text-[128px] font-black  text-[#383841] leading-none lg:-mt-5 text-center lg:text-right'>CENTRAL</p>
                        <p className='text-[#383841] font-normal text-sm md:text-xl mt-1 text-center lg:text-right'>As app developers we are fueled by coffee. Together with Ground Central we made enjoying our favorite drink even better by helping them cut wait times in stores and increase user loyalty.</p>
                        <div className='flex justify-center lg:justify-end'>
                            <Link to='/ground-central' className='flex items-center pt-4'>
