            ...
            <div id='hirebuddy' ref={ref}>
                <div className='flex flex-col-reverse lg:flex-row lg:justify-between items-center gap-16 lg:gap-0 lg:h-screen mt-32 w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto'>
                    <div style={{
                        ...
                        {/* add your own text */}
                        <p className='text-[28px] lg:text-[75px] 2xl:text-[128px] font-black  text-[#383841] leading-none text-center lg:text-left'>Hirebuddy</p>
                        <p className='text-[#383841] font-normal text-sm md:text-xl mt-1 text-center lg:text-left'>Hirebuddy app is like a social media app where you can review any people nearby you. You can review the people via sending a video, audio or text. You can play tournaments of reviewing people and earn rewards!</p>
                        <div className='flex justify-center lg:justify-start'>
                            <Link to='/hirebuddy' className='flex items-center pt-4'>
