        ...
        <div id='cakemix'>
            <div ref={ref}>
                <div className='flex flex-col lg:flex-row lg:justify-between items-center gap-16 lg:gap-0 lg:h-screen mt-32 w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto'>
                    {/* add background image in cakemix.css file */}
                    <div style={{
                        transform: isInView ? "none" : "translateX(-200px)",
                        opacity: isInView ? 1 : 0,
                        transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s"
                    }} className='bg lg:w-1/2 ' >
                        {/* add another background image in cakemix.css */}
                    ...
                    <div style={{
                        ...
                        {/* add your own text */}
                        <p className='text-[28px] lg:text-[75px] 2xl:text-[128px] font-black  text-[#383841] leading-none text-center lg:text-right'>CAKEMIX</p>
                        ...
                        <div className='flex justify-center lg:justify-end'>
                            <Link to='/cakemix' className='flex items-center pt-4'>
