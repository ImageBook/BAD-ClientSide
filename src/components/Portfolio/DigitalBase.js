                ...
                <div className='w-full lg:w-1/2 overflow-hidden lg:sticky lg:top-24'>
                    <div className=''>
                        <p data-aos="fade-down"
                            ...
                            data-aos-offset="200" className='font-black text-[40px] lg:text-[90px] tracking-wide leading-none mb-2'>DiGiTAL BASE</p>
                        <p data-aos="fade-down"
                            data-aos-duration="1000"
                            data-aos-offset="200" className='text-sm lg:text-xl mb-3'>DiGiTAL BASE app is like a social media app where you can review any people nearby you. You can review the people via sending a video, audio or text. You can play tournaments of reviewing people and earn rewards!</p>
                        <div className='w-[170px]'>
                            <Link to='/digital-base' className='flex items-center'>
