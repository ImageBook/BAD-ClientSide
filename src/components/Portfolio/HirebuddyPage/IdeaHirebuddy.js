        ...
        <div>
            <div className='flex flex-col lg:flex-row items-start justify-center gap-6 mb-20 lg:mb-28'>
                <div className='w-full lg:w-5/12'>
                    ...
                    <p className='text-[15px]'>The goal of Hirebuddy is to make people more engaging to each other. The client wanted to engage people by sharing reviews about nearby people so that people get more socially active.</p>
                </div>
                <div className='w-full lg:w-5/12'>
