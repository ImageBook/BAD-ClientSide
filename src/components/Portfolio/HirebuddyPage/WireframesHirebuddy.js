...
const WireframesHirebuddy = () => {
    return (
        <div className='mb-28 lg:mb-40'>
            ...
            <p className='text-[15px] w-full lg:w-1/2'>The goal of Hirebuddy is to make people more engaging to each other. The client wanted to engage people by sharing reviews about nearby people so that people get more socially active.</p>
...
export default WireframesHirebuddy;