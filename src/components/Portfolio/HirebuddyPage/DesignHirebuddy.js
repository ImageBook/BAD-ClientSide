...
const DesignHirebuddy = () => {
    return (
        <div className='flex flex-col-reverse lg:flex-row items-center justify-center lg:pt-20 gap-y-14'>
            ...
            <div className='w-full lg:w-1/2'>
                ...
                <div>
                    ...
                    <p className='text-[15px] mb-1'>Hirebuddy consists of cards that represent different stories. User can initiate a running story with just two steps:</p>
...
export default DesignHirebuddy;