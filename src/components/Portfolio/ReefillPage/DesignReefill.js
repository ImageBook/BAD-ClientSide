    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-center justify-center lg:pt-20 gap-10 lg:gap-0'>
            ...
            <div className='w-full lg:w-1/2'>
                ...
                <p className='mt-2'>Reefill allow people to save money by providing unlimited access to tap water for the price of one bottle. Design is interactive, intuitive and it's fun to see your progress of how many bottles and money you’ve saved.</p>
            </div>
        </div>
    );
};

export default DesignReefill;