...
const Reefill = () => {
    return (
        <div id='5' className='w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto mt-10 mb-44 lg:mt-40 lg:mb-96 text-[#383841]'>
                ...
                <div className='w-full lg:w-1/2 overflow-hidden lg:sticky lg:top-24'>
                    <div className=''>
                        <p data-aos="fade-down"
                            ...
                            data-aos-offset="200" className='font-black text-[40px] lg:text-[90px] uppercase tracking-wide leading-none mb-2'>Reefill</p>
                        <p data-aos="fade-down"
                            data-aos-duration="1000"
                            data-aos-offset="200" className='text-sm lg:text-xl mb-3'>Reefill provides a cost-effective, eco-friendly
                            alternative to bottled water. Using the app,
                            members find the nearest station, unlock it,
                            and fill their bottle in seconds.</p>
                        <div className='w-[170px]'>
                            <Link to='/reefill' className='flex items-center'>
