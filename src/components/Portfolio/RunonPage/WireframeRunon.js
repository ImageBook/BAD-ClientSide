...
const WireframeRunon = () => {
    return (
        <div className='mb-28 lg:mb-40'>
            ...
            <p className='text-[15px] w-full lg:w-1/2'>RunOn is an interesting application in that most of the time when it is used our user would not actually look at the app. Our users would be running. Hence, the goal was to make an easy to use interface that would allow users to easily re-engage with the app when they stop.</p>
