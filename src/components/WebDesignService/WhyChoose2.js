        ...
        <div className='w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto my-10 lg:my-40 text-[#383841]'>
            <div className='flex flex-col lg:flex-row items-center justify-center gap-6 md:gap-10'>
                <div className='w-full lg:w-1/2'>
                    <p className='leading-none text-[40px] lg:text-[56px] font-medium mb-2'>Why choose <br className='hidden lg:block' /> <span className='font-bold'>BAD (Best App Dev)</span> for Website Design Services?</p>
                    <p className='text-lg lg:text-xl mb-3'>BAD (Best App Dev) is one of the best web design service companies that work with you through the full application lifecycle. From business consulting, mobile app design, and custom app development, to marketing and promotion — we got you covered.</p>
                ...
                <div className='w-full lg:w-1/2 mx-auto'>
                    <div className='flex flex-col md:flex-row items-center justify-center flex-wrap gap-6 md:gap-10'>
                        ...
                        <div className='flex flex-col items-center justify-center border shadow rounded-lg bg-[#fafafa] w-full md:w-5/12 lg:h-[225px] p-2 space-y-2'>
                            ...
                            <p className='font-semibold text-lg lg:text-xl text-center leading-none'>Experts in Web Designing</p>
                        </div>
                        <div className='flex flex-col items-center justify-center border shadow rounded-lg bg-[#fafafa] w-full md:w-5/12 lg:h-[225px] p-2 space-y-2'>
                            <img className='w-[300px]' src="https://messapps.com/wp-content/themes/twentysixteen/images/newdesign/services/icon-top.svg" alt="" />
                            <p className='font-semibold text-lg lg:text-xl text-center leading-none'>Award-Winning Web Designers</p>
                        </div>
                        <div className='flex flex-col items-center justify-center border shadow rounded-lg bg-[#fafafa] w-full md:w-5/12 lg:h-[225px] p-2 space-y-2'>
                            ...
                            <p className='font-semibold text-lg lg:text-xl text-center leading-none'>Experience of Designing 100+ Websites</p>
                        </div>
                    </div>
                </div>
            </div>
