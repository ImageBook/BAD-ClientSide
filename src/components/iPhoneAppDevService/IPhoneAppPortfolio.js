        ...
        <div className='w-11/12 md:w-5/6 lg:w-11/12 xl:w-5/6 2xl:w-full mx-auto my-10 lg:my-40 text-[#383841]'>
            <div className='flex flex-col lg:flex-row items-center justify-center gap-6 md:gap-10 2xl:gap-0'>
                <div className='w-full lg:w-1/2'>
                    <p className='leading-tight lg:leading-none text-[40px] lg:text-[56px] font-medium mb-2'>iPhone Apps We Have Developed</p>
                    <p className='text-lg lg:text-xl mb-4 w-full lg:w-11/12'>A few years ago, a company wasn't considered serious if they didn't have a website. The world is developing so rapidly, that nowadays, in order to be considered a legitimate player, maintain customer loyalty, and attract new customers, you must have an application.</p>
...
export default IPhoneAppPortfolio;